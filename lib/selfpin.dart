...
import 'package:paynow/bal_dialouge.dart';
...
class self_pin extends StatefulWidget {
  const self_pin({Key? key}) : super(key: key);

  @override
  State<self_pin> createState() => _self_pinState();
}

class _self_pinState extends State<self_pin> {
